...
public abstract class AbstractGameObject
{
	 ...
	 * current animation and reset the state time to 0
	 * @param animation
	 */
	...
	/**
	 * Updates position of object in the game.
	...
	/**
	 * Handles horizontal acceleration and deceleration due to friction.
	 * @param deltaTime: Time elapsed
	 */
	...
	/**
	 * Handles vertical acceleration and deceleration due to friction.
	 * @param deltaTime: Time elapsed
	 */
